...
\draw [style=dashed,Purple] (-3.5,0.6) -- (-3,0.6) node[right] {\footnotesize 
	WebRTC 
	: sync court-terme};
\draw [->,style=dotted,red,ultra thick,opacity=0] (-3.5,-0.2) -- (-3,-0.2) node[right] 
{\small 
	Diffusion du 
	message émis par E};
%\def \n {3}
...
\draw[color=blue] (s) -- (e1);
\draw[color=blue] (s) -- (e2);
\draw [color=blue](s) -- (e3);

	\draw[style=dashed,color=Purple] (e1) -- (e2);
	\draw[style=dashed,color=Purple]  (e1) -- (e3);
	\draw[style=dashed,color=Purple]  (e2) -- (e3);
